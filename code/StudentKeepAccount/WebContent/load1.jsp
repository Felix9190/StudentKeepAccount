...
<body>
     ...
     <div id="box2">
     <font size=10 face="幼圆">按月查询</font>
     </div>
	 <br>
	 <div id="box3">
	...
	<% 
	 ...
	 <div id="box5">
	 <input type="button" value="明细查询" style="background-image:url(images/button.jpg);border-style:none;width:124px;height:93px;background-repeat:no-repeat;font-size:25px;font-weight:bold" onclick="this.form.action='load1-1.jsp';this.form.submit();">
	 &nbsp;&nbsp;&nbsp;&nbsp;
	 <input type="button" value="分类查询" style="background-image:url(images/button.jpg);border-style:none;width:124px;height:93px;background-repeat:no-repeat;font-size:25px;font-weight:bold" onclick="this.form.action='load1-2.jsp';this.form.submit();">
	 <br>
	 </form>
	 </div>
	 </div>
